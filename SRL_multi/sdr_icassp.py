...
parser.add_argument("--rainy_data_path", type=str, default="./dataset/Rain100L_ICASSP_ablation/input/", help='Path to rainy data')
parser.add_argument("--ldgp_data_path", type=str, default="./dataset/Rain100L_ICASSP_ablation/ldgp/", help='Path to ldgp data')
parser.add_argument("--sdr_result_path", type=str, default="./dataset/Rain100L_ICASSP_ablation/sdr/", help='Path to save sdr data')
...
for idx in range(len(input_folder)):    
    ...
    # crop padding
    avg_img = avg_img[padding_num:padding_num+h, padding_num:padding_num+w]

    # save
    save_path = os.path.join(result_path, input_folder[idx][:-4] + ".png")
