...
parser.add_argument("--dataset", type=str, default="Rain12", help="Dataset name")
parser.add_argument("--result_name", type=str, default="20250831_random_crop", help="Dataset name")
    ...
    try:
        ...
        for j in tqdm(range(epochs)):
            ...
            for k, inner_batch in enumerate(SDR_loader):
                sdr_images, input_img = inner_batch
